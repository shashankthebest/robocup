...
#ifndef LINEUPPAUSESTATE_H
#define LINEUPPAUSESTATE_H
...
class LineUpPauseState : public LineUpState
{
public:
    LineUpPauseState(LineUpProvider* parent) : LineUpState(parent) {};
    virtual ~LineUpPauseState() {};
