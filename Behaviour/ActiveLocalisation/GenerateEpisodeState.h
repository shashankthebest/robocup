...
#ifndef GENERATEEPISODESTATE_H
#define GENERATEEPISODESTATE_H
...
class GenerateEpisodeState : public ActiveLocalisationState
{
public:
    GenerateEpisodeState(ActiveLocalisationProvider* parent) : ActiveLocalisationState(parent)
    {
