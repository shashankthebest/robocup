...
#ifndef EVALUATEEPISODESTATE_H
#define EVALUATEEPISODESTATE_H
...
class EvaluateEpisodeState : public ActiveLocalisationState
{
public:
    EvaluateEpisodeState(ActiveLocalisationProvider* parent) : ActiveLocalisationState(parent)
    {
